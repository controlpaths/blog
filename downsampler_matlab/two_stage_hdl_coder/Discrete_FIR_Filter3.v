// ------------------------------------------------------------
// 
// File Name: two_stage_hdl/two_stage_hdl_coder/Discrete_FIR_Filter3
// Created: 2022-02-06 18:49:08
...
// Source Path: /Discrete_FIR_Filter3
// 
// ------------------------------------------------------------
// 
...
module Discrete_FIR_Filter3
               (
                ...
                enb_4_1_1,
                reset,
                Discrete_FIR_Filter3_in,
                Discrete_FIR_Filter3_out
                );

  input   clk; 
  input   enb_4_1_1; 
  input   reset; 
  input   signed [11:0] Discrete_FIR_Filter3_in; //sfix12_En11
  output  signed [11:0] Discrete_FIR_Filter3_out; //sfix12_En11

////////////////////////////////////////////////////////////////
//Module Architecture: Discrete_FIR_Filter3
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000000010001001; //sfix16_En15
  parameter signed [15:0] coeff2 = 16'b0000000010010110; //sfix16_En15
  parameter signed [15:0] coeff3 = 16'b0000000010111011; //sfix16_En15
  parameter signed [15:0] coeff4 = 16'b0000000011111001; //sfix16_En15
  parameter signed [15:0] coeff5 = 16'b0000000101001100; //sfix16_En15
  parameter signed [15:0] coeff6 = 16'b0000000110110011; //sfix16_En15
  parameter signed [15:0] coeff7 = 16'b0000001000101010; //sfix16_En15
  parameter signed [15:0] coeff8 = 16'b0000001010101101; //sfix16_En15
  parameter signed [15:0] coeff9 = 16'b0000001100111000; //sfix16_En15
  parameter signed [15:0] coeff10 = 16'b0000001111000111; //sfix16_En15
  parameter signed [15:0] coeff11 = 16'b0000010001010101; //sfix16_En15
  parameter signed [15:0] coeff12 = 16'b0000010011011101; //sfix16_En15
  parameter signed [15:0] coeff13 = 16'b0000010101011011; //sfix16_En15
  parameter signed [15:0] coeff14 = 16'b0000010111001011; //sfix16_En15
  parameter signed [15:0] coeff15 = 16'b0000011000101001; //sfix16_En15
  parameter signed [15:0] coeff16 = 16'b0000011001110011; //sfix16_En15
  parameter signed [15:0] coeff17 = 16'b0000011010100101; //sfix16_En15
  parameter signed [15:0] coeff18 = 16'b0000011010111111; //sfix16_En15
  parameter signed [15:0] coeff19 = 16'b0000011010111111; //sfix16_En15
  parameter signed [15:0] coeff20 = 16'b0000011010100101; //sfix16_En15
  parameter signed [15:0] coeff21 = 16'b0000011001110011; //sfix16_En15
  parameter signed [15:0] coeff22 = 16'b0000011000101001; //sfix16_En15
  parameter signed [15:0] coeff23 = 16'b0000010111001011; //sfix16_En15
  parameter signed [15:0] coeff24 = 16'b0000010101011011; //sfix16_En15
  parameter signed [15:0] coeff25 = 16'b0000010011011101; //sfix16_En15
  parameter signed [15:0] coeff26 = 16'b0000010001010101; //sfix16_En15
  parameter signed [15:0] coeff27 = 16'b0000001111000111; //sfix16_En15
  parameter signed [15:0] coeff28 = 16'b0000001100111000; //sfix16_En15
  parameter signed [15:0] coeff29 = 16'b0000001010101101; //sfix16_En15
  parameter signed [15:0] coeff30 = 16'b0000001000101010; //sfix16_En15
  parameter signed [15:0] coeff31 = 16'b0000000110110011; //sfix16_En15
  parameter signed [15:0] coeff32 = 16'b0000000101001100; //sfix16_En15
  parameter signed [15:0] coeff33 = 16'b0000000011111001; //sfix16_En15
  parameter signed [15:0] coeff34 = 16'b0000000010111011; //sfix16_En15
  parameter signed [15:0] coeff35 = 16'b0000000010010110; //sfix16_En15
  parameter signed [15:0] coeff36 = 16'b0000000010001001; //sfix16_En15

  // Signals
  reg  [1:0] cur_count; // ufix2
  wire phase_0; // boolean
  reg  signed [11:0] delay_pipeline [0:35] ; // sfix12_En11
  ...
  wire signed [11:0] inputmux_7; // sfix12_En11
  wire signed [11:0] inputmux_8; // sfix12_En11
  wire signed [11:0] inputmux_9; // sfix12_En11
  ...
  reg  signed [31:0] acc_out_7; // sfix32_En26
  wire signed [31:0] product_7; // sfix32_En26
  wire signed [15:0] product_7_mux; // sfix16_En15
  wire signed [27:0] mul_temp_6; // sfix28_En26
  wire signed [31:0] prod_typeconvert_7; // sfix32_En26
  wire signed [31:0] acc_sum_7; // sfix32_En26
  wire signed [31:0] acc_in_7; // sfix32_En26
  wire signed [31:0] add_cast_12; // sfix32_En26
  wire signed [31:0] add_cast_13; // sfix32_En26
  wire signed [32:0] add_temp_6; // sfix33_En26
  reg  signed [31:0] acc_out_8; // sfix32_En26
  wire signed [31:0] product_8; // sfix32_En26
  wire signed [15:0] product_8_mux; // sfix16_En15
  wire signed [27:0] mul_temp_7; // sfix28_En26
  wire signed [31:0] prod_typeconvert_8; // sfix32_En26
  wire signed [31:0] acc_sum_8; // sfix32_En26
  wire signed [31:0] acc_in_8; // sfix32_En26
  wire signed [31:0] add_cast_14; // sfix32_En26
  wire signed [31:0] add_cast_15; // sfix32_En26
  wire signed [32:0] add_temp_7; // sfix33_En26
  reg  signed [31:0] acc_out_9; // sfix32_En26
  wire signed [31:0] product_9; // sfix32_En26
  wire signed [15:0] product_9_mux; // sfix16_En15
  wire signed [27:0] mul_temp_8; // sfix28_En26
  wire signed [31:0] prod_typeconvert_9; // sfix32_En26
  wire signed [31:0] acc_sum_9; // sfix32_En26
  wire signed [31:0] acc_in_9; // sfix32_En26
  ...
  wire signed [31:0] add_cast_22; // sfix32_En26
  wire signed [31:0] add_cast_23; // sfix32_En26
  wire signed [32:0] add_temp_11; // sfix33_En26
  wire signed [31:0] sum4; // sfix32_En26
  wire signed [31:0] add_cast_24; // sfix32_En26
  wire signed [31:0] add_cast_25; // sfix32_En26
  wire signed [32:0] add_temp_12; // sfix33_En26
  wire signed [31:0] sum5; // sfix32_En26
  wire signed [31:0] add_cast_26; // sfix32_En26
  wire signed [31:0] add_cast_27; // sfix32_En26
  wire signed [32:0] add_temp_13; // sfix33_En26
  wire signed [31:0] sum6; // sfix32_En26
  wire signed [31:0] add_cast_28; // sfix32_En26
  wire signed [31:0] add_cast_29; // sfix32_En26
  wire signed [32:0] add_temp_14; // sfix33_En26
  wire signed [31:0] sum7; // sfix32_En26
  wire signed [31:0] add_cast_30; // sfix32_En26
  wire signed [31:0] add_cast_31; // sfix32_En26
  wire signed [32:0] add_temp_15; // sfix33_En26
  wire signed [31:0] sum8; // sfix32_En26
  wire signed [31:0] add_cast_32; // sfix32_En26
  wire signed [31:0] add_cast_33; // sfix32_En26
  wire signed [32:0] add_temp_16; // sfix33_En26
  ...
  assign  phase_0 = (cur_count == 2'b00 && enb_4_1_1 == 1'b1) ? 1'b1 : 1'b0;
    ...
    begin: Delay_Pipeline_process
      if (reset == 1'b1) begin
        ...
        if (phase_0 == 1'b1) begin
          delay_pipeline[0] <= Discrete_FIR_Filter3_in;
  ...
  assign inputmux_1 = (cur_count == 2'b00) ? Discrete_FIR_Filter3_in :
  ...
  assign inputmux_6 = (cur_count == 2'b00) ? delay_pipeline[19] :
                     ...
                     (cur_count == 2'b10) ? delay_pipeline[22] :
                     delay_pipeline[23];

  assign inputmux_7 = (cur_count == 2'b00) ? delay_pipeline[23] :
                     (cur_count == 2'b01) ? delay_pipeline[25] :
                     (cur_count == 2'b10) ? delay_pipeline[26] :
                     delay_pipeline[27];

  assign inputmux_8 = (cur_count == 2'b00) ? delay_pipeline[27] :
                     (cur_count == 2'b01) ? delay_pipeline[29] :
                     (cur_count == 2'b10) ? delay_pipeline[30] :
                     delay_pipeline[31];

  assign inputmux_9 = (cur_count == 2'b00) ? delay_pipeline[31] :
                     (cur_count == 2'b01) ? delay_pipeline[33] :
                     (cur_count == 2'b10) ? delay_pipeline[34] :
                     delay_pipeline[35];
  ...
  assign product_7_mux = (cur_count == 2'b00) ? coeff25 :
                        (cur_count == 2'b01) ? coeff26 :
                        (cur_count == 2'b10) ? coeff27 :
                        coeff28;
  assign mul_temp_6 = inputmux_7 * product_7_mux;
  assign product_7 = $signed({{4{mul_temp_6[27]}}, mul_temp_6});

  assign prod_typeconvert_7 = product_7;

  assign add_cast_12 = prod_typeconvert_7;
  assign add_cast_13 = acc_out_7;
  assign add_temp_6 = add_cast_12 + add_cast_13;
  assign acc_sum_7 = add_temp_6[31:0];

  assign acc_in_7 = (phase_0 == 1'b1) ? prod_typeconvert_7 :
                   acc_sum_7;
  ...
  assign product_8_mux = (cur_count == 2'b00) ? coeff29 :
                        (cur_count == 2'b01) ? coeff30 :
                        (cur_count == 2'b10) ? coeff31 :
                        coeff32;
  assign mul_temp_7 = inputmux_8 * product_8_mux;
  assign product_8 = $signed({{4{mul_temp_7[27]}}, mul_temp_7});

  assign prod_typeconvert_8 = product_8;

  assign add_cast_14 = prod_typeconvert_8;
  assign add_cast_15 = acc_out_8;
  assign add_temp_7 = add_cast_14 + add_cast_15;
  assign acc_sum_8 = add_temp_7[31:0];

  assign acc_in_8 = (phase_0 == 1'b1) ? prod_typeconvert_8 :
                   acc_sum_8;

  always @ (posedge clk or posedge reset)
    begin: Acc_reg_8_process
      if (reset == 1'b1) begin
        acc_out_8 <= 0;
      end
      else begin
    ...
    end // Acc_reg_8_process

  //   ------------------ Serial partition # 9 ------------------

  assign product_9_mux = (cur_count == 2'b00) ? coeff33 :
                        (cur_count == 2'b01) ? coeff34 :
                        (cur_count == 2'b10) ? coeff35 :
                        coeff36;
  assign mul_temp_8 = inputmux_9 * product_9_mux;
  assign product_9 = $signed({{4{mul_temp_8[27]}}, mul_temp_8});

  assign prod_typeconvert_9 = product_9;

  assign add_cast_16 = prod_typeconvert_9;
  assign add_cast_17 = acc_out_9;
  assign add_temp_8 = add_cast_16 + add_cast_17;
  assign acc_sum_9 = add_temp_8[31:0];

  assign acc_in_9 = (phase_0 == 1'b1) ? prod_typeconvert_9 :
                   acc_sum_9;

  always @ (posedge clk or posedge reset)
    begin: Acc_reg_9_process
      if (reset == 1'b1) begin
        acc_out_9 <= 0;
      end
      else begin
    ...
    end // Acc_reg_9_process

  assign add_cast_18 = acc_out_9;
  assign add_cast_19 = acc_out_8;
  assign add_temp_9 = add_cast_18 + add_cast_19;
  assign sum1 = add_temp_9[31:0];

  assign add_cast_20 = sum1;
  assign add_cast_21 = acc_out_7;
  assign add_temp_10 = add_cast_20 + add_cast_21;
  assign sum2 = add_temp_10[31:0];

  assign add_cast_22 = sum2;
  assign add_cast_23 = acc_out_6;
  assign add_temp_11 = add_cast_22 + add_cast_23;
  assign sum3 = add_temp_11[31:0];

  assign add_cast_24 = sum3;
  assign add_cast_25 = acc_out_5;
  assign add_temp_12 = add_cast_24 + add_cast_25;
  assign sum4 = add_temp_12[31:0];

  assign add_cast_26 = sum4;
  assign add_cast_27 = acc_out_4;
  assign add_temp_13 = add_cast_26 + add_cast_27;
  assign sum5 = add_temp_13[31:0];

  assign add_cast_28 = sum5;
  assign add_cast_29 = acc_out_3;
  assign add_temp_14 = add_cast_28 + add_cast_29;
  assign sum6 = add_temp_14[31:0];

  assign add_cast_30 = sum6;
  assign add_cast_31 = acc_out_2;
  assign add_temp_15 = add_cast_30 + add_cast_31;
  assign sum7 = add_temp_15[31:0];

  assign add_cast_32 = sum7;
  assign add_cast_33 = acc_out_1;
  assign add_temp_16 = add_cast_32 + add_cast_33;
  assign sum8 = add_temp_16[31:0];
  ...
  assign Discrete_FIR_Filter3_out = output_typeconvert;
endmodule  // Discrete_FIR_Filter3
