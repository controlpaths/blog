###########################################################################
## Makefile generated for component 'gm_model_biquad_wfa_interface'. 
## 
## Makefile     : gm_model_biquad_wfa_interface.mk
## Generated on : Sat Mar 20 21:19:07 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/gm_model_biquad_wfa_interface.elf
...
PRODUCT_NAME              = gm_model_biquad_wfa_interface
MAKEFILE                  = gm_model_biquad_wfa_interface.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/gm_model_biquad_wfa_interface.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/home/pablo/Documents/MATLAB/SupportPackages/R2020b/toolbox/shared/libiio/base/include -I/home/pablo/Documents/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/zynq/include -I/home/pablo/Documents/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/zynq/blocks/include -I$(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I/home/pablo/Documents/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/zynq/src -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=gm_model_biquad_wfa_interface -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = iio_helper.c $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/gm_model_biquad_wfa_interface.c $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/gm_model_biquad_wfa_interface_data.c $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/rtGetInf.c $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/rtGetNaN.c $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c /home/pablo/Documents/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/zynq/src/axi4Lite.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c

MAIN_SRC = $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/ert_main.c
...
OBJS = iio_helper.c.o gm_model_biquad_wfa_interface.c.o gm_model_biquad_wfa_interface_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o axi4Lite.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
%.c.o : $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


gm_model_biquad_wfa_interface.c.o : $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/gm_model_biquad_wfa_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


gm_model_biquad_wfa_interface_data.c.o : $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/gm_model_biquad_wfa_interface_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/gm_model_biquad_wfa_interface_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
