 ...
 * an end-user only.
 *
 * File: gm_model_biquad_wfa_interface.h
 *
...
#ifndef RTW_HEADER_gm_model_biquad_wfa_interface_h_
#define RTW_HEADER_gm_model_biquad_wfa_interface_h_
#include <math.h>
#include <string.h>
#include <float.h>
#include <stddef.h>
#ifndef gm_model_biquad_wfa_interface_COMMON_INCLUDES_
#define gm_model_biquad_wfa_interface_COMMON_INCLUDES_
#include <stdio.h>
#include "rtwtypes.h"
...
#include "unistd.h"
#include "axi_lct.h"
#endif                      /* gm_model_biquad_wfa_interface_COMMON_INCLUDES_ */

#include "gm_model_biquad_wfa_interface_types.h"
...
#define gm_model_biquad_wfa_interface_M (gm_model_biquad_wfa_interfac_M)
...
typedef struct {
  ...
  matlabshared_libiio_axistre_n_T obj_o;/* '<S1>/AXI4-Stream IIO Write' */
  zynq_AXIWrite_gm_model_biquad_T obj_n;/* '<S5>/AXI4-Interface Write' */
  zynq_AXIWrite_gm_model_biquad_T obj_a;/* '<S4>/AXI4-Interface Write' */
  struct {
    void *LoggedData;
...
extern void gm_model_biquad_wfa_interface_initialize(void);
extern void gm_model_biquad_wfa_interface_step(void);
extern void gm_model_biquad_wfa_interface_terminate(void);
 ...
 *
 * '<Root>' : 'gm_model_biquad_wfa_interface'
 * '<S1>'   : 'gm_model_biquad_wfa_interface/Subsystem'
 * '<S2>'   : 'gm_model_biquad_wfa_interface/Subsystem/model_biquad_wfa'
 * '<S3>'   : 'gm_model_biquad_wfa_interface/Subsystem/model_biquad_wfa/AXI4SlaveWrite'
 * '<S4>'   : 'gm_model_biquad_wfa_interface/Subsystem/model_biquad_wfa/AXI4SlaveWrite/AXI4SlaveWrite_axi4_incos'
 * '<S5>'   : 'gm_model_biquad_wfa_interface/Subsystem/model_biquad_wfa/AXI4SlaveWrite/AXI4SlaveWrite_axi4_wkn'
 */
#endif                         /* RTW_HEADER_gm_model_biquad_wfa_interface_h_ */
