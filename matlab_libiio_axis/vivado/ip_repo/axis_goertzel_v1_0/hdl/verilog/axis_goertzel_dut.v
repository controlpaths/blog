// -------------------------------------------------------------
// 
// File Name: hdl_prj/hdlsrc/model/axis_goertzel_dut.v
...
// -------------------------------------------------------------
// 
// Module: axis_goertzel_dut
// Source Path: axis_goertzel/axis_goertzel_dut
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module axis_goertzel_dut
  ...
  axis_goertzel_src_model u_axis_goertzel_src_model (.clk(clk),
                                                     .clk_enable(enb),
                                                     .reset(reset),
