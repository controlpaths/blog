// -------------------------------------------------------------
// 
// File Name: hdl_prj/hdlsrc/model/axis_goertzel_fifo_TLAST_OUT.v
...
// -------------------------------------------------------------
// 
// Module: axis_goertzel_fifo_TLAST_OUT
// Source Path: axis_goertzel/axis_goertzel_axi4_stream_master/axis_goertzel_fifo_TLAST_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module axis_goertzel_fifo_TLAST_OUT
  ...
  axis_goertzel_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                              .DataWidth(1)
                                              )
                                            u_axis_goertzel_fifo_TLAST_OUT_classic_ram_singlebit (.clk(clk),
                                                                                                  .enb(enb),
                                                                                                  .wr_din(In),  // ufix1
                                                                                                  .wr_addr(w_waddr),
                                                                                                  .wr_en(w_we),  // ufix1
...
endmodule  // axis_goertzel_fifo_TLAST_OUT
