// -------------------------------------------------------------
// 
// File Name: hdl_prj/hdlsrc/model/axis_goertzel_src_model.v
...
// -------------------------------------------------------------
// 
// Module: axis_goertzel_src_model
// Source Path: model
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module axis_goertzel_src_model
  ...
  axis_goertzel_src_goertzel_system u_goertzel_system (.clk(clk),
                                                       .reset(reset),
                                                       .enb(clk_enable),
                                                       ...
                                                       .re_data_out_valid(goertzel_system_out3)
                                                       );
...
endmodule  // axis_goertzel_src_model
