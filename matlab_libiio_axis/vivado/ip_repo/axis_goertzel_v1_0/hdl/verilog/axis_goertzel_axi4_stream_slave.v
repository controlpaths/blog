// -------------------------------------------------------------
// 
// File Name: hdl_prj/hdlsrc/model/axis_goertzel_axi4_stream_slave.v
...
// -------------------------------------------------------------
// 
// Module: axis_goertzel_axi4_stream_slave
// Source Path: axis_goertzel/axis_goertzel_axi4_stream_slave
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module axis_goertzel_axi4_stream_slave
  ...
  axis_goertzel_fifo_data u_axis_goertzel_fifo_data_inst (.clk(clk),
                                                          .reset(reset),
                                                          .enb(enb),
...
endmodule  // axis_goertzel_axi4_stream_slave
