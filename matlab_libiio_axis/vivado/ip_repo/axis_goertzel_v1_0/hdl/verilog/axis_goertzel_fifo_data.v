// -------------------------------------------------------------
// 
// File Name: hdl_prj/hdlsrc/model/axis_goertzel_fifo_data.v
...
// -------------------------------------------------------------
// 
// Module: axis_goertzel_fifo_data
// Source Path: axis_goertzel/axis_goertzel_axi4_stream_slave/axis_goertzel_fifo_data
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module axis_goertzel_fifo_data
  ...
  axis_goertzel_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                            .DataWidth(32)
                                            )
                                          u_axis_goertzel_fifo_data_classic_ram (.clk(clk),
                                                                                 .enb(enb),
                                                                                 .wr_din(In),
                                                                                 .wr_addr(w_waddr),
                                                                                 .wr_en(w_we),  // ufix1
...
endmodule  // axis_goertzel_fifo_data
