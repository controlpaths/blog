// -------------------------------------------------------------
// 
// File Name: hdl_prj/hdlsrc/model/axis_goertzel_ip_axi4_stream_master.v
...
module axis_goertzel_ip_axi4_stream_master
  ...
  axis_goertzel_ip_fifo_data_OUT u_axis_goertzel_ip_fifo_data_OUT_inst (.clk(clk),
                                                                        .reset(reset),
                                                                        .enb(enb),
                                                                        .In(user_data),  // ufix32
  ...
  axis_goertzel_ip_fifo_TLAST_OUT u_axis_goertzel_ip_fifo_TLAST_OUT_inst (.clk(clk),
                                                                          .reset(reset),
                                                                          .enb(enb),
                                                                          .In(auto_tlast),  // ufix1
                                                                          .Push(fifo_push),  // ufix1
...
endmodule  // axis_goertzel_ip_axi4_stream_master
