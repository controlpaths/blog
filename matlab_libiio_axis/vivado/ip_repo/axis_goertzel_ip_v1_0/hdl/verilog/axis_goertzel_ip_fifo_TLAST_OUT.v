// -------------------------------------------------------------
// 
// File Name: hdl_prj/hdlsrc/model/axis_goertzel_ip_fifo_TLAST_OUT.v
...
module axis_goertzel_ip_fifo_TLAST_OUT
  ...
  axis_goertzel_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                                 .DataWidth(1)
                                                 )
                                               u_axis_goertzel_ip_fifo_TLAST_OUT_classic_ram_singlebit (.clk(clk),
                                                                                                        .enb(enb),
                                                                                                        .wr_din(In),  // ufix1
                                                                                                        .wr_addr(w_waddr),
                                                                                                        .wr_en(w_we),  // ufix1
...
endmodule  // axis_goertzel_ip_fifo_TLAST_OUT
