// -------------------------------------------------------------
// 
// File Name: hdl_prj/hdlsrc/model/axis_goertzel_ip_fifo_data_OUT.v
...
module axis_goertzel_ip_fifo_data_OUT
  ...
  axis_goertzel_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                             ...
                                             u_axis_goertzel_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                                   .enb(enb),
                                                                                                   .wr_din(In),
                                                                                                   .wr_addr(w_waddr),
                                                                                                   .wr_en(w_we),  // ufix1
...
endmodule  // axis_goertzel_ip_fifo_data_OUT
