-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_biquad_wfa/axis_goertzel_ip_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axis_goertzel_ip_reset_sync
-- Source Path: axis_goertzel_ip/axis_goertzel_ip_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axis_goertzel_ip_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END axis_goertzel_ip_reset_sync;


ARCHITECTURE rtl OF axis_goertzel_ip_reset_sync IS
