-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_biquad_wfa/axis_goertzel_ip_axi_lite.vhd
...
ENTITY axis_goertzel_ip_axi_lite IS
...
END axis_goertzel_ip_axi_lite;


ARCHITECTURE rtl OF axis_goertzel_ip_axi_lite IS

  -- Component Declarations
  COMPONENT axis_goertzel_ip_addr_decoder
  ...
  COMPONENT axis_goertzel_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : axis_goertzel_ip_addr_decoder
    USE ENTITY work.axis_goertzel_ip_addr_decoder(rtl);

  FOR ALL : axis_goertzel_ip_axi_lite_module
    USE ENTITY work.axis_goertzel_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_axi4_incos_tmp             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_axi4_wkn_tmp               : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_axis_goertzel_ip_addr_decoder_inst : axis_goertzel_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_axi4_incos => write_axi4_incos_tmp,  -- sfix32_En16
              write_axi4_wkn => write_axi4_wkn_tmp  -- sfix32_En16
              );

  u_axis_goertzel_ip_axi_lite_module_inst : axis_goertzel_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_axi4_incos <= write_axi4_incos_tmp;

  write_axi4_wkn <= write_axi4_wkn_tmp;
