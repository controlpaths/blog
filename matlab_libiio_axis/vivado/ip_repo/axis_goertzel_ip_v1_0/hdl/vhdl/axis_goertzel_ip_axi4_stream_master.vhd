-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_biquad_wfa/axis_goertzel_ip_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axis_goertzel_ip_axi4_stream_master
-- Source Path: axis_goertzel_ip/axis_goertzel_ip_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axis_goertzel_ip_axi4_stream_master IS
...
END axis_goertzel_ip_axi4_stream_master;


ARCHITECTURE rtl OF axis_goertzel_ip_axi4_stream_master IS

  -- Component Declarations
  COMPONENT axis_goertzel_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT axis_goertzel_ip_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : axis_goertzel_ip_fifo_data_OUT
    USE ENTITY work.axis_goertzel_ip_fifo_data_OUT(rtl);

  FOR ALL : axis_goertzel_ip_fifo_TLAST_OUT
    USE ENTITY work.axis_goertzel_ip_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_axis_goertzel_ip_fifo_data_OUT_inst : axis_goertzel_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_axis_goertzel_ip_fifo_TLAST_OUT_inst : axis_goertzel_ip_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
