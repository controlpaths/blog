-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_biquad_wfa/axis_goertzel_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axis_goertzel_ip_fifo_TLAST_OUT
-- Source Path: axis_goertzel_ip/axis_goertzel_ip_axi4_stream_master/axis_goertzel_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axis_goertzel_ip_fifo_TLAST_OUT IS
...
END axis_goertzel_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF axis_goertzel_ip_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT axis_goertzel_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : axis_goertzel_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.axis_goertzel_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_axis_goertzel_ip_fifo_TLAST_OUT_classic_ram_singlebit : axis_goertzel_ip_SimpleDualPortRAM_singlebit
