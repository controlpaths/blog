-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_biquad_wfa/axis_goertzel_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axis_goertzel_ip_fifo_data_OUT
-- Source Path: axis_goertzel_ip/axis_goertzel_ip_axi4_stream_master/axis_goertzel_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axis_goertzel_ip_fifo_data_OUT IS
...
END axis_goertzel_ip_fifo_data_OUT;


ARCHITECTURE rtl OF axis_goertzel_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT axis_goertzel_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : axis_goertzel_ip_SimpleDualPortRAM_generic
    USE ENTITY work.axis_goertzel_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_axis_goertzel_ip_fifo_data_OUT_classic_ram_generic : axis_goertzel_ip_SimpleDualPortRAM_generic
