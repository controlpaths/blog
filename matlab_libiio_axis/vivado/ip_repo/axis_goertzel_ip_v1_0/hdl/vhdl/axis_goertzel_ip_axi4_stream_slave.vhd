-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/model_biquad_wfa/axis_goertzel_ip_axi4_stream_slave.vhd
...
ENTITY axis_goertzel_ip_axi4_stream_slave IS
...
END axis_goertzel_ip_axi4_stream_slave;


ARCHITECTURE rtl OF axis_goertzel_ip_axi4_stream_slave IS

  -- Component Declarations
  COMPONENT axis_goertzel_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : axis_goertzel_ip_fifo_data
    USE ENTITY work.axis_goertzel_ip_fifo_data(rtl);
...
BEGIN
  u_axis_goertzel_ip_fifo_data_inst : axis_goertzel_ip_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
