...
#define  IPCore_Timestamp_axis_goertzel_ip                       0xC  //contains unique IP timestamp (yymmddHHMM): 2103172002
#define  cos_input_Data_axis_goertzel_ip                         0x100  //data register for Inport cos_input
#define  wkn_re_Data_axis_goertzel_ip                            0x104  //data register for Inport wkn_re
#define  wkn_im_Data_axis_goertzel_ip                            0x108  //data register for Inport wkn_im
