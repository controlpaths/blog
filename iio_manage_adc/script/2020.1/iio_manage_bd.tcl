...
################################################################
# This is a generated script based on design: picozed_bd
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net adc_miso_1 [get_bd_ports adc_miso] [get_bd_pins processing_system7_0/SPI0_MISO_I]
  ...
  connect_bd_net -net processing_system7_0_SPI0_MOSI_O [get_bd_ports adc_mosi] [get_bd_pins processing_system7_0/SPI0_MOSI_O]
  connect_bd_net -net processing_system7_0_SPI0_SCLK_O [get_bd_ports adc_sck] [get_bd_pins processing_system7_0/SPI0_SCLK_O]
  connect_bd_net -net processing_system7_0_SPI0_SS_O [get_bd_ports adc_cs] [get_bd_pins processing_system7_0/SPI0_SS_O]
